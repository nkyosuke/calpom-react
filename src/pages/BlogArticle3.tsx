    ...
    <div className="max-w-3xl mx-auto px-4 py-12 text-gray-800">
      ...
      <div className="bg-white shadow-md rounded-xl p-6 mb-8 border">
        ...
        <p className="text-gray-700">
          25分間の作業 + 5分間の休憩 を1セットとする集中力維持法。1980年代にフランチェスコ・シリロ氏が考案しました。
          キッチンタイマーの形がトマト（イタリア語で pomodoro）だったことが由来です。
        </p>
      </div>
      ...
      <div className="bg-white shadow-md rounded-xl p-6 mb-8 border">
        ...
        <p className="text-gray-700">
          ...
          集中開始から20〜30分で減少し始めることがわかっています。<br />
          ポモドーロ法はその限界を前提に、短い集中と小休憩を繰り返すことでパフォーマンスを最大化する手法なのです。
        </p>
      </div>
